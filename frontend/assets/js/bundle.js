...
function showErrorMessage(input, msg) {
    ...
    const formFields = input.parentElement; //filtrando o elemento pai do input. O input é o campo lá em si, e o elemento pai é o primeiro que engloba ele, no caso, a div form fiedls
    const errorMessage = formFields.querySelector('.error-message'); //filtrando as mensagens de erro das divs
